...
<div class="col-md-12  ">
    ...
    <img class="img-circle img-thumbnail "  src="<?=base_url()?>images/forum/avatar/<?=@$this->db->get_where('forum_comments',array('thread_id'=>$forum->id_thead))->result()[0]->autor_id?>.jpg">
        ...
        <div class="col-md-8 pad10">
            <div class="col-md-12 forum_title"><a class="forum_href" data-target="<?=base_url()?>forum/view_thread/<?=$forum->id_thead?>" href="<?=base_url()?>forum/view_thread/<?=$forum->id_thead?>"><?=$forum->title?></a></div>
